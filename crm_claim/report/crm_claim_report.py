...
class CrmClaimReport(models.Model):
    ...
    _auto = False
    _description = "CRM Complaints Report"
    ...
    nbr_claims = fields.Integer(string="# of Complaints", readonly=True)
    ...
    subject = fields.Char(string="Complaint Subject", readonly=True)
