...
class AccountMove(models.Model):
    ...
    is_complained = fields.Boolean(string="Complained", default=False)
...
class AccountMoveLine(models.Model):
    ...
    wizard_complaints_id = fields.Many2one('crm.claim', string='Wizard')
    complained_qty = fields.Float(string='Complained Quantity')
