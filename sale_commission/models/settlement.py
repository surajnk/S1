    ...
    def make_invoices(self, journal, product, date=False):
        ...
        for settlement in self:
            ...
            invoice_vals_list.append((0, 0, {
                ...
                'name': _("Period: from %s to %s") % (date_from.strftime(lang.date_format), date_to.strftime(lang.date_format)),
        ...
        invoices.invoice_line_ids = invoice_vals_list
        invoices.remaining_commission_total = invoices.amount_residual
