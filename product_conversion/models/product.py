...
class ProductConversion(models.Model):
    ...
    def onchange_product_uom(self):
        ...
        if not self.src_product_id:
            self.src_uom = False
        if self.src_lot:
            check_lot_qty = self.env['stock.quant']._get_available_quantity(self.src_product_id, self.from_location, self.src_lot, allow_negative=True)
            ...
            check_product_qty = self.env['stock.quant']._get_available_quantity(self.src_product_id, self.from_location, allow_negative=True)
