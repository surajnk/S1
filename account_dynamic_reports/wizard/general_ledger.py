...
class InsGeneralLedger(models.TransientModel):
    ...
    def write(self, vals):
        ...
        print(vals, "dssssssssssssssssss")
    ...
    def process_data(self):
        ...
        for account in account_ids:
            ...
            if self.branch_ids:
                if len(self.branch_ids.ids) == 1:
                    WHERE_FULL += " AND res_branch.id = {}".format(tuple(self.branch_ids.ids)[0])
                else:
                    WHERE_FULL += " AND res_branch.id in {}".format(tuple(self.branch_ids.ids))
