...
class StockMoveLine(models.Model):
    ...
    def _onchange_product_id(self):
        if self.product_id:
            _logger.info("HERRRREEEE STOCK MOVE LINE ONCHANGEE")
    ...
    @api.onchange('lot_id')
    def _onchange_lots_number(self):
        if self.lot_id:
    ...
    def write(self, vals):
        ...
        if updates or 'qty_done' in vals:
            ...
            for ml in mls:
                ...
                _logger.info("HERE ATLEASEEEEE'%s'",ml.location_id)
